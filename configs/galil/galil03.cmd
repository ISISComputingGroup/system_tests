...
GalilStartController("Galil","$(GALIL)/gmc/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Home_RevLimit+FIpos.gmc!$(GALIL)/gmc/galil_Home_RevLimit+FIpos.gmc!$(GALIL)/gmc/galil_Home_RevLimit+FIpos.gmc!$(GALIL)/gmc/galil_Home_ForwLimit+FIneg.gmc!$(GALIL)/gmc/galil_Home_Dummy_Power_Light.gmc!$(GALIL)/gmc/galil_Home_Dummy_Power_Light.gmc!$(GALIL)/gmc/galil_Home_Dummy_Power_Light.gmc!$(GALIL)/gmc/galil_Home_Dummy_Power_Light.gmc;$(GALIL)/gmc/galil_Default_Footer.gmc",0,0,3)
